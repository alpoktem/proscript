...
Rscript get-pros-norm.r $file_id f0 $outdir/raw-f0/ $outdir $alignfile
Rscript get-pros-norm.r $file_id i0 $outdir/raw-i0/ $outdir $alignfile

#extract normalized prosody features
Rscript get-pros-window.r $file_id f0 $outdir $alignfile
Rscript get-pros-window.r $file_id i0 $outdir $alignfile
